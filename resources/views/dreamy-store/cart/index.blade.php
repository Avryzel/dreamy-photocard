...
<body>
        ...
        <div class="container">
            ...
            @else
                <div class="py-20 text-center">
                    ...
                    <a href="{{ route('home') }}" class="mt-4 inline-block bg-[#5865D9] text-white px-6 py-2 rounded-full text-sm font-bold hover:bg-[#4650b6] transition">
                        Cari Bias Sekarang
                    </a>
                </div>
            @endif
    ...
    <footer style="background: linear-gradient(135deg, #9FA8DA, #B39DDB); padding: 40px 20px; text-align: center; color: white; box-shadow: 0 -4px 10px rgba(0,0,0,0.05);">
    ...
    @if(session('success'))
        <div class="alert-box bg-green-500 shadow-lg" id="notif">✅ {{ session('success') }}</div>
